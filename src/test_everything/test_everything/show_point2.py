...
class TestGetPoint(Node):
    def __init__(self):
        ...
        # subscription
        self.subscription = self.create_subscription(Float32MultiArray, 'hopenet_1', self.subscription_callback, 10)

        # publisher
        self.publisher_ = self.create_publisher(Marker, 'point_2', 10)

        self.points = []

    def subscription_callback(self, msg):
        # Get data
        x, y, z, yaw, pitch, roll = msg.data
        self.points = [x, y, z]
